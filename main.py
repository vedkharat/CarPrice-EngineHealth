...
PRICE_MODEL_URL = "https://drive.google.com/file/d/1cfNPQwWBjt_QXYVFE_7pUa-rahi8yVEi/view?usp=drive_link"
...
def download_if_missing(url: str, dest: Path):
    ...
    try:
        ...
        st.error("❌ Could not download the price model file. Please try again later.")
        st.exception(e)
        st.stop()
